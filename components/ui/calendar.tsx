...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 [--day-size:2.25rem] [--cell-size:var(--day-size)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
...
function CalendarDayButton({
  ...
  const isClickable = Boolean(modifiers.hasEntries);
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-[var(--day-size)] w-[var(--day-size)] items-center justify-center rounded-md text-sm font-normal ring-offset-background transition-colors",
